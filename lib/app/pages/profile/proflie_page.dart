...
import 'package:edu_learn_app/app/pages/profile/bloc/profile_event.dart';
import 'package:edu_learn_app/app/pages/profile/bloc/profile_state.dart';
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 10),
                  state is SignOutErrorState ? Text(state.error) : Container(),
