...
import 'package:edu_learn_app/app/pages/payment/bloc/payment_event.dart';
import 'package:edu_learn_app/app/pages/payment/bloc/payment_state.dart';
  ...
  Widget _buildUIDiscountAnVoucher() {
    return Column(
      ...
      children: [
        ...
        selectedCode.isEmpty ? Container() : buildCardCode(selectedCode),
        // _buildUIDiscountAnVoucher(),
        buildLine(),
